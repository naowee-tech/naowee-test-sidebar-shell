...
const ICONS = {
  ...
  whistle:     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="3" width="12" height="18" rx="2"/><path d="M9 3v2h6V3"/><path d="M9 11h6"/><path d="M9 15h4"/><circle cx="17" cy="17" r="2.2"/><path d="M18.5 18.5L20 20"/></svg>',
