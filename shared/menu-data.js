...
const ICONS = {
  ...
  whistle:     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="13" r="6"/><path d="M15 13L21 7"/><path d="M21 4l-2 3"/></svg>',
